async function fetchIlocosNorteStatistics() {
  try {
    const provinceId = 'P001';
...
async function fetchIlocosNorteLanguage() {
  const provinceId = 'P001';
...
async function fetchIlocosNorteDelicacies() {
  try {
    const provinceId = 'P001';
...
async function fetchIlocosNorteTouristSpots() {
  try {
    const provinceId = 'P001';
