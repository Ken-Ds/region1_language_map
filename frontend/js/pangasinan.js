async function fetchPangasinanStatistics() {
  try {
    const provinceId = 'P004';
...
async function fetchPangasinanLanguage() {
  const provinceId = 'P004';
...
async function fetchPangasinanDelicacies() {
  try {
    const provinceId = 'P004';
    ...
    console.error('Error fetching Pangasinan delicacy data:', error);
  }
}

async function fetchPangasinanTouristSpots() {
  try {
    const provinceId = 'P004';
    ...
    console.error('Error fetching Pangasinan tourist spot data:', error);
  }
}